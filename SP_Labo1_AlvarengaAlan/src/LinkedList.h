 ...
 * @brief Recorre la lista de estructuras que estan en la Linked list, y se les añade un parametro determinado
 *
 * @param this Lista donde estan las estructuras
 * @param pFunc Funcion que se encargara de insertar los valores
 * @return Retorna 1 si salio bien y 0 si salio mal
 */
int ll_map(LinkedList* this, int (*pFunc)(void*));
/**
 * @fn LinkedList ll_filter*(LinkedList*, int(*)(void*))
 * @brief Recorre la lista de estructuras que estan en la LinkedList y se chequea si cumplen ciertos parametros, para luego añadirlas a otra LinkedList
 *
 * @param this Lista de estructuras
 * @param pFunc Funcion que se encarga de chequear si x estructura cumple con los parametros
 * @return Retorna la linkedList con los parametros que cumplen con lo pedido
 */
